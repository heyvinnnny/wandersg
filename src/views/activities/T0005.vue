            ...
            <md-card>
              ...
              >
                ...
                <slide>
                  ...
                  <img
                    src="@/assets/act-img/t0005-2.jpg"
                    alt="carousel2"
                    style="height:auto;"
                  />
                </slide>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Experience a fun water adventure at the first floating aqua
                  park in Singapore, right in the heart of Sentosa. Spend the
                  day at HydroDash Singapore and enjoy the family-friendly
                  inflatable water park. Dash through four thrill-seeking
                  floating obstacle courses that caters to all ages!
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  Weekdays: 12pm-6pm, Weekends and Public Holidays and School
                  Holidays: 10am-7pm
                </p>
                ...
                <p class="text-muted text-sm">
                  72 Palawan Beach Walk, Sentosa<br />
                  Singapore (099344)
                </p>
                ...
                <p class="text-muted text-sm">
                  <md-button
                    class="md-danger"
                    style="width:100px;"
                    href="https://www.klook.com/en-SG/activity/51613-1-hour-hydrodash-admission-singapore/"
                    >KLOOK</md-button
                  >
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-activity", "HydroDash");
