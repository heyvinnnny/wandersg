          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Centrally situated at the front of Emerald Hill, Acid Bar has
                  two seating areas for you to choose from. Whether you want to
                  people-watch or enjoy a more intimate setting, we're here for
                  you!
                </p>
                <p class="text-muted">
                  Gracing the kitchens is Executive Chef Kar Meng who is a
                  graduate of Le Cordon Bleu Culinary Institute in Sydney,
                  Australia. Beginning his culinary career in Melbourne, Chef
                  Meng has since then graced the kitchens of restaurants like
                  Red Tail Bar by Zouk, Chinoiserie and 1-Michelin starred
                  restaurant, Jag. He now helms the kitchen at Acid Bar, so be
                  sure to pop by for the ultimate dining experience.
                </p>
              </div>
              <br />
              <div class="col-lg-4">
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-food", "Acid Bar");
