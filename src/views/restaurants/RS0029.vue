    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">Lerouy
          ...
          <md-card>
            ...
            >
              <slide>
                ...
                <img src="@/assets/res-img/rs0029-1.jpg" alt="carousel1" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
                ...
                <img src="@/assets/res-img/rs0029-2.jpg" alt="carousel2" />
              </slide>
            ...
            <slide>
                ...
                <img src="@/assets/res-img/rs0029-3.jpg" alt="carousel2" />
              </slide>
            ...
            <slide>
                ...
                <img src="@/assets/res-img/rs0029-4.jpg" alt="carousel2" />
              </slide>
            ...
            <slide>
                ...
                <img src="@/assets/res-img/rs0029-5.jpg" alt="carousel2" />
              </slide>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8">
              ...
              <p class="text-muted">
                It is a modern French cooking thats served at Lerouy. True to the modern ethos that permeates the entire establishment, the setting features an elegant, winding counter which curves around an open kitchen. The restaurant offers a tasting menu which evolves and changes from time to time, but which constantly features exciting creations with the chef’s strong individual stamp. The only thing predictable about Lerouy is the consistently excellent cooking which never fails to impress, so do head down sometime soon and give it a go!
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">Modern European, French, Fusion</p>
              <h4 class="h5 text-uppercase">Hours</h4>
              <p class="text-muted text-sm">Wed-Sat: 12-2pm, 6-10pm <br>
Closed Sunday, Monday, and Tuesday<br> </p>
              <h4 class="h5 text-uppercase">Good for: </h4>
              <p class="text-muted text-sm">Business Meetings, Fine Dining, Drinks, Private Functions, Quiet Dinner</p>
              <h4 class="h5 text-uppercase">Location</h4>
              <p class="text-muted text-sm">Tanjong Pagar</p>
              <h4 class="h5 text-uppercase">Address</h4>
              <p class="text-muted text-sm">104 Amoy Street <br>
Singapore (069924) <br>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="Lerouy" readonly></gmap-autocomplete>
