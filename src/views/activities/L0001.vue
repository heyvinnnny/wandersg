            ...
            <md-card>
              ...
              >
                ...
                <slide>
                  ...
                  <img
                    src="@/assets/act-img/l0001-2.jpg"
                    alt="carousel2"
                    style="height:auto;"
                  />
                </slide>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Gardens by the Bay is an iconic Singapore destination and is
                  undoubtedly at the top of every visitor’s itinerary to the
                  city. Its waterfront gardens (Bay South, Bay East, and Bay
                  Central) and conservatories (the Flower Dome and Cloud Forest)
                  as well as the newly opened Sun Pavilion, feature some of the
                  most incredible man-made structures built to house flora and
                  fauna from all over the world. Your Singapore Gardens by the
                  Bay ticket gives you full access to the two conservatories and
                  what’s more, you can even enter directly with your Klook
                  voucher. Learn about the power interconnectedness of ecology,
                  see the tallest indoor waterfall, and walk amid the Supertree
                  Grove. With countless attractions for both grown-ups and
                  children, Gardens by the Bay in Singapore will certainly
                  ensure that you’ll have a day well-spent.
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  <md-button
                    class="md-danger"
                    style="width:100px;"
                    href="https://www.klook.com/en-SG/activity/127-gardens-by-the-bay-singapore/"
                    >KLOOK</md-button
                  >
                  <md-button
                    class="md-info"
                    style="width:100px; margin-left:20px;"
                    href="https://www.kkday.com/en-us/product/3158-gardens-by-the-bay-singapore-flower-dome-cloud-forest-tickets"
                    >KKDAY</md-button
                  >
                </p>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-activity", "Gardens by the Bay");
