            ...
            <md-card>
              ...
              >
                <slide>
                  ...
                  <img src="@/assets/res-img/rs0013-1.jpg" alt="carousel1" />
                </slide>
                <slide>
                  <div class="carousel-caption">
                    <h4></h4>
                  </div>
                  <img src="@/assets/res-img/rs0013-2.jpg" alt="carousel2" />
                </slide>
                <slide>
                  <div class="carousel-caption">
                    <h4></h4>
                  </div>
                  <img src="@/assets/res-img/rs0013-3.jpg" alt="carousel2" />
                </slide>
              </carousel>
            </md-card>
          </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  With all the Italian options in Singapore, it's no wonder the
                  competition is stiff enough to see many a restaurant come and
                  go, but Al Forno has stood the test of time and tastiness with
                  a beautifully simple philosophy. Take the freshest Italian
                  ingredients, make dishes that people know and love, and the
                  diners will come. And while it's now a common claim to source
                  ingredients like vine ripened whole tomatoes and peppery
                  parmigiana directly from Italy, Al Forno was the first to do
                  so, with exclusive imports since 1995. That means the dishes
                  here have been tasted, tweaked and perfected so that you can't
                  go wrong with anything on the diligently genuine, yet
                  approachable menu.
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  Bar, Italian, All-Day Breakfast, Vegetarian Friendly
                </p>
                <h4 class="h5 text-uppercase">Hours</h4>
                <p class="text-muted text-sm">
                  Mon-Thu: 5-10:30pm<br />
                  Fri-Sat: 3-10:30pm<br />
                  Sun: 12-10pm
                </p>
                <h4 class="h5 text-uppercase">Good for:</h4>
                <p class="text-muted text-sm">
                  Al Fresco, Business Meetings, Casual Dining, Kid Friendly,
                  Drinks, Pet Friendly, Private Functions, Large Parties (16+)
                </p>
                <h4 class="h5 text-uppercase">Location</h4>
                <p class="text-muted text-sm">East Coast</p>
                <h4 class="h5 text-uppercase">Address</h4>
                <p class="text-muted text-sm">
                  693A East Coast Road <br />
                  Singapore (459058)
                </p>
          ...
          <div>
            <label>
              <gmap-autocomplete
                ...
                value="Al Forno Tapas and Wine Bar"
                readonly
              ></gmap-autocomplete>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-food", "Al Forno Tapas and Wine Bar");
