          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Savour refined Cantonese cuisine in a modern upscale setting
                  that is a sophisticated mix of romance and nostalgia. Ideal
                  for intimate dining sessions is two private dining suites,
                  which seat 12 and 8.
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  Chinese, Seafood, Vegetarian Friendly, Local, Dim Sum
                </p>
                <h4 class="h5 text-uppercase">Hours</h4>
                <p class="text-muted text-sm">
                  Tue-Sun: 12-2:30pm, 6-10:30pm (Last Order: 9:45pm)<br />
                  Closed Monday
                </p>
                <h4 class="h5 text-uppercase">Good for:</h4>
                <p class="text-muted text-sm">
                  Business Meetings, City Views, Casual Dining, Drinks
                </p>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-food", "5 ON 25 五悦亭");
