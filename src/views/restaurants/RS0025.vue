    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">Ki-Sho
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">Mon-Fri (Excluding PH): 12-2:30pm, 6:30-10:30pm<br>
Sat: 6:30-10:30pm<br>
Closed Sunday<br>
</p>
              ...
              <p class="text-muted text-sm">29 Scotts Road<br>
Singapore (228224)<br>
                </p>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="Ki-Sho" readonly></gmap-autocomplete>
