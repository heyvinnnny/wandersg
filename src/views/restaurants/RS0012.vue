          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Acoustics Coffee is guided by the simplicity of providing a
                  restorative safe space for customers. They infuse quality and
                  natural ingredients into their menu and provide a “sound”
                  environment for relaxation and conversation over coffee and
                  food.
                </p>
                <p class="text-muted">
                  Serving all-day brunch, go for their Breakfast at Acoustics
                  for a taste of all their best breakfast offerings, including
                  maple glazed bacon. For the sweet tooth, have a go at their
                  signature Acoustics Pancakes, generously adorned with nutty
                  crumble and fresh banana slices that are guaranteed to fill
                  you up.
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  Sun-Thu: 8:30am-5:30pm<br />
                  Fri-Sat: 8:30am-9:30pm<br />
                </p>
                <h4 class="h5 text-uppercase">Good for:</h4>
                <p class="text-muted text-sm">
                  Al Fresco, Casual Dining, Drinks, Pet Friendly
                </p>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-food", "Acoustics Coffee Bar");
