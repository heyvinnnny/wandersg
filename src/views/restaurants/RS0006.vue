    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">21 on Rajah
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8">
              ...
              <p class="text-muted">
                Explore the different combination of flavours with 21 on Rajah unique spread of Mediterr-Asian Buffet. Indulge in familiar street delicacies while exploring Mediterranean’s exotic flavours.

              </p>
              <p class="text-muted">Think a rijsttafel (rice table)-inspired sumptuous buffet spread filled with Mediterranean favourites such as Traditional Greek Salad with Marinated Feta Cheese and Black Olives, Grilled Lamb Chop with Garlic-Mint Sauce and Eggplant, Okra and Tomato Tagine. In additional to the ice crustacean bar and the carving station serving the restaurant's signatures NZ Prime Beef Rib-Eye with 21 On Rajah Signature Homemade Sauces and Slow-Cooked Salted Salmon in Tamarind Sauce, there is a new station featuring items such as Seafood and Chicken Paella, Tortilla de Patatas Espanola (Spanish Omelette with Potatoes) and assorted pizzas.
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">Buffet, Vegetarian Friendly, Local, Halal Certified</p>
              ...
              <p class="text-muted text-sm">1 Jalan Rajah<br>
Singapore (329133)
                </p>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="21 on Rajah" readonly></gmap-autocomplete>
