    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">Singapore Zoo
          ...
          <md-card>
            ...
            >
              ...
              <slide>
                ...
                <img src="@/assets/act-img/a0002-2.jpg" alt="carousel2" style="height:auto;" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
...
Singapore (729826)
              ...
              <p class="text-muted text-sm">
                <md-button class="md-danger" style="width:100px;" href="https://www.klook.com/en-SG/activity/141-singapore-zoo-singapore/">KLOOK</md-button>   
                <md-button class="md-info" style="width:100px; margin-left:20px;" href="https://www.kkday.com/en-us/product/100148-singapore-zoo-ticket">KKDAY</md-button>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="Singapore Zoo " style="width:300px;" readonly></gmap-autocomplete>
