            ...
            <md-card>
              ...
              >
                ...
                <slide>
                  ...
                  <img
                    src="@/assets/act-img/m0002-2.jpg"
                    alt="carousel2"
                    style="height:auto;"
                  />
                </slide>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Make the most of your children’s school holidays or birthday
                  party and take the whole family to Science Centre Singapore.
                  The learning institution is considered one of the top science
                  centres in the world. One of the must-see features of the
                  Science Centre Singapore is the Singapore Omni Theatre,
                  Singapore’s only dome-shaped, 5-story high theatre using the
                  world’s latest and brightest 8K Digital Fulldome System.
                  Butterfly lovers will also enjoy Butterflies Up-Close, the
                  centre’s very own indoor butterfly sanctuary, which will give
                  visitors a closer glimpse into the life cycle of these winged
                  creatures. You can also observe various butterfly specimens
                  and how a butterfly behaves in this live butterfly enclosure.
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  <md-button
                    class="md-danger"
                    style="width:100px;"
                    href="https://www.klook.com/en-SG/activity/1347-science-centre-singapore-omni-theatre-movie-singapore/"
                    >KLOOK</md-button
                  >
                  <md-button
                    class="md-info"
                    style="width:100px; margin-left:20px;"
                    href="https://www.kkday.com/en-sg/product/103520-singapore-science-centre-ticket"
                    >KKDAY</md-button
                  >
                </p>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-activity", "Science Centre");
