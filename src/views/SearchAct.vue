  ...
  <div class="wrapper">
    ...
    <div class="main main-raised">
      <div class="section section-basic">
         ...
         <ais-instant-search :search-client="searchClient" index-name="wander-activity">
        ...
        <div class = "InterfaceDemoResultsZone withFiltersBlock editMode listDisplay">
          ...
          <ais-InfiniteHits style="width:1000px; margin:auto;">
            ...
            <div class = "Image" style="margin-right:20px">
              ...
              <a :href="item.actID">
                <img :src="item.image" align="left" :alt="item.activityname" style="height:100px"/>
                </a>
              </picture>
            </div>
            <div class="Attributes">
              <div class="FirstRow">
                <div class="PrimaryAttribute" style="font-weight:bold; font-size:large;">
                  <ais-highlight attribute="activityname" :hit="item" class="lined mb-4" highlightedTagName="mark"/>
                </div>
              </div>
              <br>
              <div class="SecondaryAttribute">
                <ais-snippet attribute="description" highlighted-tag-name="em" :hit="item"/>
                <ais-highlight attribute="district" :hit="item" highlightedTagName="mark"/>
              </div>
              <br>
...
export default {
  ...
  methods: {
    ...
    getStaticValues: (items) => {
      const staticValues = ["Theme & Water Parks", 'Attraction Passes', 'Natural Landscape & Gardens', 'Museum & Galleries', 'Observation & Cable Cars', 'Aquariums, zoos & farms'];
