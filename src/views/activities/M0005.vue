            ...
            <md-card>
              ...
              >
                <slide>
                  ...
                  <img src="@/assets/act-img/m0005-1.jpg" alt="carousel1" />
                </slide>
                <slide>
                  <div class="carousel-caption">
                    <h4></h4>
                  ...
                  <img
                    src="@/assets/act-img/m0005-2.jpg"
                    alt="carousel2"
                    style="height:auto;"
                  />
                </slide>
                <slide>
                  ...
                  <img src="@/assets/act-img/m0005-3.jpg" alt="carousel2" />
                </slide>
              </carousel>
            </md-card>
          </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Explore Southeast Asian art at the new National Gallery
                  Singapore. After opening its doors on 24 Nov 2015, the gallery
                  is located in Singapore's Civic District and boasts a combined
                  floor area of 64,000 square meters and is housed in two of the
                  island's most iconic buildings: former Supreme Court and City
                  Hall. National Gallery Singapore is the largest visual arts
                  venue and museum in Singapore – home to over 1,000 art works
                  and it is certainly one of the main attractions in Singapore.
                  Visitors are introduced to Singaporean and Southeast Asian art
                  in the long-term and special exhibitions taking place at the
                  gallery. A visit to the National Gallery Singapore is a great
                  opportunity to discover art, culture and architecture of
                  Singapore.
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  Mon-Sun, 10:00-13:00, 14:00-17:00
                </p>

                <h4 class="h5 text-uppercase">Location</h4>
                <p class="text-muted text-sm">Raffles Place</p>
                <h4 class="h5 text-uppercase">Address</h4>
                <p class="text-muted text-sm">
                  1 St. Andrew's Rd Singapore<br />
                  Singapore (178957)
                </p>
                ...
                <p class="text-muted text-sm">
                  <md-button
                    class="md-danger"
                    style="width:100px;"
                    href="https://www.klook.com/en-SG/activity/1256-national-gallery-singapore/"
                    >KLOOK</md-button
                  >
                  <md-button
                    class="md-info"
                    style="width:100px; margin-left:20px;"
                    href="https://www.kkday.com/en-sg/product/13358-national-gallery-singapore-ticket"
                    >KKDAY</md-button
                  >
                </p>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-activity", "National Gallery");
