            ...
            <md-card>
              ...
              >
                ...
                <slide>
                  ...
                  <img
                    src="@/assets/act-img/t0004-2.jpg"
                    alt="carousel2"
                    style="height:auto;"
                  />
                </slide>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Go in for the ultimate cooldown in Snow City Singapore. Try
                  snowtubing and making snow angels in the tropics! Enjoy loads
                  of winter fun in the center of the tropical city: play
                  snowballs, see ice sculptures, visit an igloo and more!
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  Tues-Fri, 10:00-17:00 (Last Admission: 16:00)<br />
                  Weekends, Schools and Public Holidays, 10:00-18:00 (Last
                  Admission: 17:00)
                </p>
                ...
                <p class="text-muted text-sm">
                  <md-button
                    class="md-danger"
                    style="width:100px;"
                    href="https://www.klook.com/en-SG/activity/1348-snow-play-session-in-snow-city-singapore/"
                    >KLOOK</md-button
                  >
                  <md-button
                    class="md-info"
                    style="width:100px; margin-left:20px;"
                    href="https://www.kkday.com/en-sg/product/13923-snow-city-ticket-singapore"
                    >KKDAY</md-button
                  >
                </p>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-activity", "Snow City");
