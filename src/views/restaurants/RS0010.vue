            ...
            <md-card>
              ...
              >
                <slide>
                  ...
                  <img src="@/assets/res-img/rs0010-1.jpg" alt="carousel1" />
                </slide>
                <slide>
                  <div class="carousel-caption">
                    <h4></h4>
                  </div>
                  <img src="@/assets/res-img/rs0010-2.jpg" alt="carousel2" />
                </slide>
                <slide>
                  <div class="carousel-caption">
                    <h4></h4>
                  </div>
                  <img src="@/assets/res-img/rs0010-3.jpg" alt="carousel2" />
                </slide>
              </carousel>
            </md-card>
          </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Following the philosophy that good food can also be affordably
                  priced, 5 Senses Bistro serves up comfort dishes, reminiscent
                  of mama’s cooking. The kitchen team takes pride in the food
                  they cook, as seen from the attention to detail — Carbonara,
                  for instance, an all time favourite pasta dish with slivers of
                  juicy bacon, cook to al dente, precise 62°C poached egg
                  finishing off with freshly grated parmesan cheese.
                </p>
                <p class="text-muted">
                  The restaurant’s signature dish, Confit French Duck Leg and
                  Pan Seared Norwegian Salmon, are also a delight to tuck into.
                  For a heartier, full bodied main course, try the 150 Days
                  Grain-Fed Angus Braised Beef Cheek. The beef is cooked for
                  long hours so that the meat is meltingly soft and fork-tender,
                  suffused with a rich, heady flavour from the gravy. Be sure to
                  save some space for dessert. Classics like the Apple Crumble
                  and a delicious, warm Chocolate Lava Cake are sweet comforts
                  to indulge in at the end of the meal.
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  Modern European, French, Fusion, Seafood, Cafe
                </p>
                <h4 class="h5 text-uppercase">Hours</h4>
                <p class="text-muted text-sm">Mon-Sun: 11am-9pm</p>
                <h4 class="h5 text-uppercase">Good for:</h4>
                <p class="text-muted text-sm">
                  Al Fresco, Business Meetings, City Views, Casual Dining, Kid
                  Friendly, Drinks, Private Functions
                </p>
          ...
          <div>
            <label>
              <gmap-autocomplete
                ...
                value="5 Senses Bistro (Funan Mall)"
                readonly
              ></gmap-autocomplete>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-food", "5 Senses Bistro (Funan Mall)");
