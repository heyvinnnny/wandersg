    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">13% Wine Bistro @ Telok Ayer
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8">
              ...
              <p class="text-muted">
              13% Wine Bistro was founded on a shared love of fine wine, great food, and the unpretentious atmosphere of vineyards across Europe.

              </p>
              <p class="text-muted">Snugly nestled on the second floor, simple furniture and walls loaded with frames fade into the background as the enormous chalkboard panel listing specials and recommendations draws your attention. Warm bulbs and aqua lights tracking along the 8-metre mosaic bar set a cosy scene whilst diners peruse the special Iberico and cheese counter, or take their seats and eagerly await the delicious parade of contemporary European cuisine and international wines to come.
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">Mon-Fri: 12-11pm
Sat: 5-11pm<br>
Closed Sunday</p>
              <h4 class="h5 text-uppercase">Good for: </h4>
              <p class="text-muted text-sm">Casual Dining, Drinks, Private Functions</p>
              <h4 class="h5 text-uppercase">Location</h4>
              <p class="text-muted text-sm">Telok Ayer</p>
              <h4 class="h5 text-uppercase">Address</h4>
              <p class="text-muted text-sm">123A Telok Ayer Street<br>
Singapore (068592) <br>
                </p>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="13% Wine Bistro @ Telok Ayer" readonly></gmap-autocomplete>
