    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">Al Forno Tapas and Wine Bar
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">Bar, Italian, All-Day Breakfast, Vegetarian Friendly</p>
              <h4 class="h5 text-uppercase">Hours</h4>
              <p class="text-muted text-sm">Mon-Thu: 5-10:30pm<br>
Fri-Sat: 3-10:30pm<br>
Sun: 12-10pm</p>
              <h4 class="h5 text-uppercase">Good for: </h4>
              <p class="text-muted text-sm">Al Fresco, Business Meetings, Casual Dining, Kid Friendly, Drinks, Pet Friendly, Private Functions, Large Parties (16+)</p>
              <h4 class="h5 text-uppercase">Location</h4>
              <p class="text-muted text-sm">East Coast</p>
              <h4 class="h5 text-uppercase">Address</h4>
              <p class="text-muted text-sm">693A East Coast Road <br>
Singapore (459058)
                </p>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="Al Forno Tapas and Wine Bar" readonly></gmap-autocomplete>
