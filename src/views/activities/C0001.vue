            ...
            <md-card>
              ...
              >
                ...
                <slide>
                  ...
                  <img
                    src="@/assets/act-img/c0001-2.jpg"
                    alt="carousel2"
                    style="height:auto;"
                  />
                </slide>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Take in impressive 360° aerial views of Singapore’s urban
                  city, lush greenery of Mount Faber and Sentosa onboard the
                  Singapore Cable Car. Have fun exploring Sentosa with Unlimited
                  Rides and see the views evolve from day to night. To savor the
                  magnificent views for even longer and delight in a unique
                  dining experience, you can enjoy a set lunch at Mount Faber
                  Peak Station or a dinner buffet at Good Old Days Restaurant
                  within Sentosa.
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  <md-button
                    class="md-danger"
                    style="width:100px;"
                    href="https://www.klook.com/en-SG/activity/130-faber-peak-cable-car-singapore/"
                    >KLOOK</md-button
                  >
                  <md-button
                    class="md-info"
                    style="width:100px; margin-left:20px;"
                    href="https://www.kkday.com/en-us/product/17933-singapore-cable-car-tickets-skypass"
                    >KKDAY</md-button
                  >
                </p>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-activity", "Singapore Cable Car");
