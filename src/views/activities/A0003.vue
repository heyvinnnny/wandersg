            ...
            <md-card>
              ...
              >
                ...
                <slide>
                  ...
                  <img
                    src="@/assets/act-img/a0003-2.jpg"
                    alt="carousel2"
                    style="height:auto;"
                  />
                </slide>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Meet and interact with thousands of birds at Asia's largest
                  bird paradise. Discover a collection of over 5,000 colorful
                  birds from 400 species, across over 20.2 hectares of
                  exploratory landscapes, naturalistic environments and giant
                  walk-in aviaries. Prepare to be amazed by the Waterfall Aviary
                  that houses one of the world's tallest man-made, indoor
                  waterfalls towering at a height of 35m (equivalent to 13
                  storeys).
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  <md-button
                    class="md-danger"
                    style="width:100px;"
                    href="https://www.klook.com/en-SG/activity/123-jurong-bird-park-singapore/"
                    >KLOOK</md-button
                  >
                  <md-button
                    class="md-info"
                    style="width:100px; margin-left:20px;"
                    href="https://www.kkday.com/en-sg/product/2967-jurong-bird-park-ticket-singapore"
                    >KKDAY</md-button
                  >
                </p>
