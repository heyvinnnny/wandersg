    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">basdban
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8">
              ...
              <p class="text-muted">
               basdban is a literal translation of a Sichuanese slang (巴适的板) which means awesomeness.

              </p>
              <p class="text-muted">At basdban, we aim to break away from the typical Sichuanese food that you can find locally by offering authentic flavours with a western twist. Here we provide an East-meets-West fusion where we bring the best of both worlds in dishes meant for sharing that is the usual setting in every Chinese family dinner.
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">Bar, Chinese, Fusion, Southeast Asian</p>
              <h4 class="h5 text-uppercase">Hours</h4>
              <p class="text-muted text-sm">Mon-Sat: 11am-3pm (Last Order: 2:30pm), 6-9:30pm (Last Order: 9pm)<br>
Closed Sunday</p>
              <h4 class="h5 text-uppercase">Good for: </h4>
              <p class="text-muted text-sm">Al Fresco, City Views, Casual Dining, Kid Friendly, Drinks, Private Functions, Romantic Dates</p>
              <h4 class="h5 text-uppercase">Location</h4>
              <p class="text-muted text-sm">Telok Ayer</p>
              <h4 class="h5 text-uppercase">Address</h4>
              <p class="text-muted text-sm">51 Telok Ayer Street<br>
#01-01<br>
Singapore (048441)<br>
                </p>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="basdban" readonly></gmap-autocomplete>
