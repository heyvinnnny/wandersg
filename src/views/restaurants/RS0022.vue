    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">Feast Roxy
          ...
          <md-card>
            ...
            >
              <slide>
                ...
                <img src="@/assets/res-img/rs0022-1.jpg" alt="carousel1" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
                ...
                <img src="@/assets/res-img/rs0022-2.jpg" alt="carousel2" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
                ...
                <img src="@/assets/res-img/rs0022-3.jpg" alt="carousel2" />
              </slide>
            </carousel>
          </md-card>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8">
              ...
              <p class="text-muted">
                Eat, drink and meet at Feast Roxy, a new multi-concept restaurant set as the ideal venue to cater to multiple lifestyle settings. Be it a casual dinner, intimate catch up or small scale gatherings, Feast Roxy is a great place for all.
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">Buffet, International, Local, Southeast Asian</p>
              <h4 class="h5 text-uppercase">Hours</h4>
              <p class="text-muted text-sm">Mon-Sun: 12-9pm</p>
              <h4 class="h5 text-uppercase">Good for: </h4>
              <p class="text-muted text-sm">Casual Dining, Kid Friendly, Drinks</p>
              <h4 class="h5 text-uppercase">Location</h4>
              <p class="text-muted text-sm">East Coast</p>
              <h4 class="h5 text-uppercase">Address</h4>
              <p class="text-muted text-sm">50 East Coast Road<br>
Grand Mercure Singapore Roxy<br>
Singapore (428769)
                </p>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="Feast Roxy" readonly></gmap-autocomplete>
