        ...
        <div class="md-layout">
          <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
            <h1 class="text-uppercase lined mb-4" style="color:palevioletred">
              Burrata Joy and Gustavo Lapasta by Garibaldi
              <md-button
                v-if="loggedIn"
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Gustavo Lapasta: translates into “what I used to appreciate”.
                  Discover, through us, the gourmet pastas we are used to
                  treasuring back home with our friends and family. Burrata Joy:
                  indulge yourself in a creamy inside with a delightful finish,
                  fully capable of leaving you craving for more, Burrata - it
              ...
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  Modern European, Italian, Seafood, Vegetarian Friendly
                </p>
                ...
                <p class="text-muted text-sm">
                  Casual Dining, Kid Friendly, Drinks, Quiet Dinner, Romantic
                  Dates
                </p>
          ...
          <div>
            <label>
              <gmap-autocomplete
                ...
                value="Burrata Joy and Gustavo Lapasta by Garibaldi"
                readonly
              ></gmap-autocomplete>
