          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  mber West, a student operated restaurant, brings affordable
                  gourmet selections prepared by student chefs and served by
                  student servers, to those who visit the in-house fine dining
                  training restaurant, located right in the heart of ITE College
                  West’s vast campus at Choa Chu Kang. The restaurant serves to
                  train students in an authentic learning environment at
                  affordable prices and features a tantalising collection of
                  dishes, both Western and Asian cuisine with a twist.
                </p>
                <p class="text-muted">
                  Specialising in Asian and Western cuisine, the restaurant
                  serves up four course meals that will definitely get you bang
                  for your buck.
                </p>
              </div>
              <br />
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-food", "Amber West");
