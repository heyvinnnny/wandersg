    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">5 Senses Bistro (Funan Mall)
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">Modern European, French, Fusion, Seafood, Cafe</p>
              <h4 class="h5 text-uppercase">Hours</h4>
              <p class="text-muted text-sm">Mon-Sun: 11am-9pm</p>
              <h4 class="h5 text-uppercase">Good for: </h4>
              <p class="text-muted text-sm">Al Fresco, Business Meetings, City Views, Casual Dining, Kid Friendly, Drinks, Private Functions</p>
              <h4 class="h5 text-uppercase">Location</h4>
              <p class="text-muted text-sm">City Hall</p>
              <h4 class="h5 text-uppercase">Address</h4>
              <p class="text-muted text-sm">107 North Bridge Road<br>
#02-17<br>
Funan Mall<br>
Singapore (179105)<br>
                </p>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="5 Senses Bistro (Funan Mall)" readonly></gmap-autocomplete>
