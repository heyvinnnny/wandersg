            ...
            <md-card>
              ...
              >
                <slide>
                  ...
                  <img src="@/assets/res-img/rs0004-1.jpg" alt="carousel1" />
                </slide>
                <slide>
                  <div class="carousel-caption">
                    <h4></h4>
                  </div>
                  <img src="@/assets/res-img/rs0004-2.jpg" alt="carousel2" />
                </slide>
                <slide>
                  <div class="carousel-caption">
                    <h4></h4>
                  </div>
                  <img src="@/assets/res-img/rs0004-3.jpg" alt="carousel2" />
                </slide>
              </carousel>
            </md-card>
          </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  13% Wine Bistro was founded on a shared love of fine wine,
                  great food, and the unpretentious atmosphere of vineyards
                  across Europe.
                </p>
                <p class="text-muted">
                  Snugly nestled on the second floor, simple furniture and walls
                  loaded with frames fade into the background as the enormous
                  chalkboard panel listing specials and recommendations draws
                  your attention. Warm bulbs and aqua lights tracking along the
                  8-metre mosaic bar set a cosy scene whilst diners peruse the
                  special Iberico and cheese counter, or take their seats and
                  eagerly await the delicious parade of contemporary European
                  cuisine and international wines to come.
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">Modern European</p>
                <h4 class="h5 text-uppercase">Hours</h4>
                <p class="text-muted text-sm">
                  Mon-Fri: 12-11pm Sat: 5-11pm<br />
                  Closed Sunday
                </p>
          ...
          <div>
            <label>
              <gmap-autocomplete
                ...
                value="13% Wine Bistro @ Telok Ayer"
                readonly
              ></gmap-autocomplete>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-food", "13% Wine Bistro @ Telok Ayer");
