    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">National Museum Singapore
          ...
          <md-card>
            ...
            >
              ...
              <slide>
                ...
                <img src="@/assets/act-img/m0006-2.jpg" alt="carousel2" style="height:auto;" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">93 Stamford Road<br>
Singapore (178897)
                </p>
              ...
              <p class="text-muted text-sm">
                <md-button class="md-danger" style="width:100px;" href="https://www.klook.com/en-SG/activity/1199-national-museum-singapore/">KLOOK</md-button>   
                <md-button class="md-info" style="width:100px; margin-left:20px;" href="https://www.kkday.com/en-sg/product/25506-national-museum-singapore-ticket">KKDAY</md-button>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="National Museum Singapore" style="width:300px;" readonly></gmap-autocomplete>
