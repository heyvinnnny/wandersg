    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">5 ON 25 五悦亭
          ...
          <md-card>
            ...
            >
              <slide>
                ...
                <img src="@/assets/res-img/rs0002-1.jpg" alt="carousel1" />
              </slide>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8">
              ...
              <p class="text-muted">
              Savour refined Cantonese cuisine in a modern upscale setting that is a sophisticated mix of romance and nostalgia. Ideal for intimate dining sessions is two private dining suites, which seat 12 and 8.
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">Chinese, Seafood, Vegetarian Friendly, Local, Dim Sum</p>
              <h4 class="h5 text-uppercase">Hours</h4>
              <p class="text-muted text-sm">Tue-Sun: 12-2:30pm, 6-10:30pm (Last Order: 9:45pm)<br>
Closed Monday</p>
              <h4 class="h5 text-uppercase">Good for: </h4>
              <p class="text-muted text-sm">Business Meetings, City Views, Casual Dining, Drinks</p>
              <h4 class="h5 text-uppercase">Location</h4>
              <p class="text-muted text-sm">Bugis</p>
              <h4 class="h5 text-uppercase">Address</h4>
              <p class="text-muted text-sm">5 Fraser Street<br>
Level 25<br>
Andaz Singapore<br>
Singapore (189354)<br>
                </p>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="5 ON 25 五悦亭" readonly></gmap-autocomplete>
