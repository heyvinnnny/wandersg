          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Eat, drink and meet at Feast Roxy, a new multi-concept
                  restaurant set as the ideal venue to cater to multiple
                  lifestyle settings. Be it a casual dinner, intimate catch up
                  or small scale gatherings, Feast Roxy is a great place for
                  all.
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  Buffet, International, Local, Southeast Asian
                </p>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-food", "Feast Roxy");
