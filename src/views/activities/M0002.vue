    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">Science Centre
          ...
          <md-card>
            ...
            >
              <slide>
                ...
                <img src="@/assets/act-img/m0002-1.jpg" alt="carousel1" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
                ...
                <img src="@/assets/act-img/m0002-2.jpg" alt="carousel2" style="height:auto;" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
                ...
                <img src="@/assets/act-img/m0002-3.jpg" alt="carousel2" />
              </slide>
            </carousel>
          </md-card>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8">
              ...
              <p class="text-muted">
               Make the most of your children’s school holidays or birthday party and take the whole family to Science Centre Singapore. The learning institution is considered one of the top science centres in the world. One of the must-see features of the Science Centre Singapore is the Singapore Omni Theatre, Singapore’s only dome-shaped, 5-story high theatre using the world’s latest and brightest 8K Digital Fulldome System. Butterfly lovers will also enjoy Butterflies Up-Close, the centre’s very own indoor butterfly sanctuary, which will give visitors a closer glimpse into the life cycle of these winged creatures. You can also observe various butterfly specimens and how a butterfly behaves in this live butterfly enclosure.
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">Mon-Sun, 10:00-13:00, 14:00-17:00</p>

              <h4 class="h5 text-uppercase">Location</h4>
              <p class="text-muted text-sm">Jurong East</p>
              <h4 class="h5 text-uppercase">Address</h4>
              <p class="text-muted text-sm">15 Science Centre Rd<br>
Singapore (609081)
                </p>
              ...
              <p class="text-muted text-sm">
                <md-button class="md-danger" style="width:100px;" href="https://www.klook.com/en-SG/activity/1347-science-centre-singapore-omni-theatre-movie-singapore/">KLOOK</md-button>   
                <md-button class="md-info" style="width:100px; margin-left:20px;" href="https://www.kkday.com/en-sg/product/103520-singapore-science-centre-ticket">KKDAY</md-button>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="Science Centre" style="width:300px;" readonly></gmap-autocomplete>
