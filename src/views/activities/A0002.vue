            ...
            <md-card>
              ...
              >
                <slide>
                  ...
                  <img src="@/assets/act-img/a0002-1.jpg" alt="carousel1" />
                </slide>
                <slide>
                  <div class="carousel-caption">
                    <h4></h4>
                  ...
                  <img
                    src="@/assets/act-img/a0002-2.jpg"
                    alt="carousel2"
                    style="height:auto;"
                  />
                </slide>
                <slide>
                  ...
                  <img src="@/assets/act-img/a0002-3.jpg" alt="carousel2" />
                </slide>
              </carousel>
            </md-card>
          </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Set in one of the most beautiful wildlife environments in the
                  world, Singapore Zoo is home to over 2,800 animals from over
                  300 species of mammals, birds and reptiles that roam freely in
                  open enclosures resembling their natural habitats, separated
                  from visitors only by moats and wooden fencing. The park also
                  boasts the world's first free-ranging orangutan habitat in a
                  zoo! Spend a day exploring this award winning zoo - a great
              ...
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  <md-button
                    class="md-danger"
                    style="width:100px;"
                    href="https://www.klook.com/en-SG/activity/141-singapore-zoo-singapore/"
                    >KLOOK</md-button
                  >
                  <md-button
                    class="md-info"
                    style="width:100px; margin-left:20px;"
                    href="https://www.kkday.com/en-us/product/100148-singapore-zoo-ticket"
                    >KKDAY</md-button
                  >
                </p>
