    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">Acoustics Coffee Bar
          ...
          <md-card>
            ...
            >
              <slide>
                ...
                <img src="@/assets/res-img/rs0012-1.jpg" alt="carousel1" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
                ...
                <img src="@/assets/res-img/rs0012-2.jpg" alt="carousel2" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
                ...
                <img src="@/assets/res-img/rs0012-3.jpg" alt="carousel2" />
              </slide>
            </carousel>
          </md-card>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8">
              ...
              <p class="text-muted">
                Acoustics Coffee is guided by the simplicity of providing a restorative safe space for customers. They infuse quality and natural ingredients into their menu and provide a “sound” environment for relaxation and conversation over coffee and food.


              </p>
              <p class="text-muted">Serving all-day brunch, go for their Breakfast at Acoustics for a taste of all their best breakfast offerings, including maple glazed bacon. For the sweet tooth, have a go at their signature Acoustics Pancakes, generously adorned with nutty crumble and fresh banana slices that are guaranteed to fill you up.
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">All-Day Breakfast, Cafe</p>
              <h4 class="h5 text-uppercase">Hours</h4>
              <p class="text-muted text-sm">Sun-Thu: 8:30am-5:30pm<br>
Fri-Sat: 8:30am-9:30pm<br>
</p>
              <h4 class="h5 text-uppercase">Good for: </h4>
              <p class="text-muted text-sm">Al Fresco, Casual Dining, Drinks, Pet Friendly</p>
              <h4 class="h5 text-uppercase">Location</h4>
              <p class="text-muted text-sm">Chinatown, Outram</p>
              <h4 class="h5 text-uppercase">Address</h4>
              <p class="text-muted text-sm">61 Neil Road <br>
Singapore (088895) <br>
                </p>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="Acoustics Coffee Bar" readonly></gmap-autocomplete>
