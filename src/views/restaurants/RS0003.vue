    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">10 SCOTTS
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8">
              ...
              <p class="text-muted">Enjoy a complimentary champagne package upgrade with every "Themed Cocktails & Mocktails" package purchased when you sign up as a World of Hyatt member at 10 SCOTTS, or if you are already a World of Hyatt Elite member. 
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">Bar, Buffet, Japanese, Seafood, British</p>
              ...
              <p class="text-muted text-sm">Business Meetings, Casual Dining, Kid Friendly, Drinks, Private Functions</p>
              <h4 class="h5 text-uppercase">Location</h4>
              <p class="text-muted text-sm">Orchard</p>
              <h4 class="h5 text-uppercase">Address</h4>
              <p class="text-muted text-sm">10 Scotts Road<br>
Lobby Level<br>
...
Singapore (228211)<br>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="10 SCOTTS" readonly></gmap-autocomplete>
