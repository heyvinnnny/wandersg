    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">Amber West
          ...
          <md-card>
            ...
            >
              <slide>
                ...
                <img src="@/assets/res-img/rs0014-1.jpg" alt="carousel1" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
                ...
                <img src="@/assets/res-img/rs0014-2.jpg" alt="carousel2" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
                ...
                <img src="@/assets/res-img/rs0014-3.jpg" alt="carousel2" />
              </slide>
            </carousel>
          </md-card>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8">
              ...
              <p class="text-muted">
                mber West, a student operated restaurant, brings affordable gourmet selections prepared by student chefs and served by student servers, to those who visit the in-house fine dining training restaurant, located right in the heart of ITE College West’s vast campus at Choa Chu Kang. The restaurant serves to train students in an authentic learning environment at affordable prices and features a tantalising collection of dishes, both Western and Asian cuisine with a twist.

              </p>
              <p class="text-muted">Specialising in Asian and Western cuisine, the restaurant serves up four course meals that will definitely get you bang for your buck.
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">International</p>
              <h4 class="h5 text-uppercase">Hours</h4>
              <p class="text-muted text-sm">Mon: 12-2pm<br>
Tue-Fri: 12-2pm, 6-8pm<br>
Closed Saturday and Sunday</p>
              <h4 class="h5 text-uppercase">Good for: </h4>
              <p class="text-muted text-sm">Casual Dining, Quiet Dinner</p>
              <h4 class="h5 text-uppercase">Location</h4>
              <p class="text-muted text-sm">Choa Chu Kang</p>
              <h4 class="h5 text-uppercase">Address</h4>
              <p class="text-muted text-sm">1 Choa Chu Kang Grove <br>
Singapore (688236)<br>
                </p>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="Amber West" readonly></gmap-autocomplete>
