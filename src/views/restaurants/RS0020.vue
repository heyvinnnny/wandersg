            ...
            <md-card>
              ...
              >
                <slide>
                  ...
                  <img src="@/assets/res-img/rs0020-1.jpg" alt="carousel1" />
                </slide>
                <slide>
                  <div class="carousel-caption">
                    <h4></h4>
                  </div>
                  <img src="@/assets/res-img/rs0020-2.jpg" alt="carousel2" />
                </slide>
                <slide>
                  <div class="carousel-caption">
                    <h4></h4>
                  </div>
                  <img src="@/assets/res-img/rs0020-3.jpg" alt="carousel2" />
                </slide>
              </carousel>
            </md-card>
          </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  A Bukit Timah favourite for mouth-watering pastas and
                  authentic pizzas, Capri Trattoria & Pizzeria is an Italian
                  eatery we’re certain everyone will love. Offering a warm and
                  rustic ambiance, along with an authentic region-centric menu,
                  it’s one spot that’s got traditional Italian eats in the bag!
                </p>
                <p class="text-muted">
                  With something on the menu for everyone, Capri Trattoria’s à
                  la carte menu is where most people will want to start. From
                  seafood fans who’ll find the Gamberi e Cappesante alle Erbe,
                  warm prawns and scallops with mediterranean herbs, remarkable
                  to the meat eaters who’ll yearn to devour the Cotoletta alla
                  Milanese, a juicy 300g bone-in deep-fried breaded veal chop,
                  substantial eats is what this Italian eatery is all about!
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">Italian</p>
                <h4 class="h5 text-uppercase">Hours</h4>
                <p class="text-muted text-sm">
                  Tue-Sun: 12-2:30pm, 6-10:30pm<br />
                  Closed Monday<br />
                </p>
                ...
                <p class="text-muted text-sm">Bukit Timah</p>
          ...
          <div>
            <label>
              <gmap-autocomplete
                ...
                value="Capri Trattoria and Pizzeria"
                readonly
              ></gmap-autocomplete>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-food", "Capri Trattoria & Pizzeria");
