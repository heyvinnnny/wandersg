          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  2D1N Soju Bang is the sister restaurant to the popular Korean
                  BBQ joint Ssikkek, located just upstairs. At 2D1N, the focus
                  is on authentic, homely Korean cuisine. The Ginseng Chicken
                  Soup, for instance, is a comforting dish featuring a plump,
                  tender chicken simmered in a nourishing broth infused with
                  slices of spiced ginger and spring onions.
                </p>
                <p class="text-muted">
                  Meat lovers will also love the Korean steamed spicy chicken. A
                  healthier alternative to the deep-fried version, the meat here
                  is tossed with the same sweet spicy sauce, and steamed until
                  tender. Potatoes, carrots, and onions are accompaniments that
                  turn this dish into a hearty stew.
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  Korean, Vegetarian Friendly, BBQ
                </p>
                <h4 class="h5 text-uppercase">Hours</h4>
                <p class="text-muted text-sm">
                  Tue-Sun: 11:30am-2:30pm, 5pm-12am<br />
                  Closed Monday
                </p>
                <h4 class="h5 text-uppercase">Good for:</h4>
                <p class="text-muted text-sm">
                  Casual Dining, Kid Friendly, Drinks, Private Functions, Large
                  Parties (16+)
                </p>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-food", "2D1N Soju Bang");
