  ...
  <div class="wrapper">
        ...
        <div class="md-layout-item">
          <div class="image-wrapper">
            <div class="brand">
              ...
              <h3 style="color:white;">Search for your favourite activity and restaurant.</h3>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="main main-raised">
      <div class="section section-basic" style="">
        ...
        <ais-instant-search :search-client="searchClient" index-name="wander-restaurant" >
    <div class ="left-panel" style="padding-left:20px; margin-left: 200px; font-family: monaco,Consolas,Lucida Console,monospace;">
      <ais-clear-refinements style="color:palevioletred;"/>
      <h2>Restaurants</h2>
      <h3>Category</h3>
      <ais-refinement-list attribute="category" :transformItems="getStaticValues" style="color:palevioletred;"/>

      <h3>District</h3>
      <ais-refinement-list attribute="district" :transformItems="getStaticValues1" style="color:palevioletred;"/>

      <h3>Price</h3>
      <ais-refinement-list attribute="price" :transformItems="getStaticValues2" style="color:palevioletred;"/>

      <!-- <ais-configure :hitsPerPage="8" /> -->

    </div>
    <div class ="right-panel" style="color:palevioletred; padding-right:300px;">
      <ais-search-box style="width:1000px; margin:auto;"/>
      <div class="OutputResultsAndFilters">
        <div class = "InterfaceDemoResultsZone withFiltersBlock editMode listDisplay">
          <div class = "ZoneHeader" style="width:1000px; margin:auto;">
    
            <div class="HitsDetails">
              <div class="NbHits">
                <div class="ais-Stats">
                  <span class="ais-Stats-text lined mb-4" style="font-weight: bold; font-size: medium;">Results</span>
                  </div>
                </div>
          ...
          <ais-InfiniteHits style="width:1000px; margin:auto;">
            <template v-slot:item="{ item }" class="InterfaceDemoHit" style="height:300px;">
            <!-- <h2>{{ item.activityname }}</h2> -->
            <div class = "Image" style="margin-right:20px" >
              <picture class="stl-flex stl-items-center stl-justify-center" >
                <a :href="item.resID">
                  <img :src="item.image" align="left" :alt="item.activityname" style="height:110px;" />
                </a>
              </picture>
            </div>
            <div class="Attributes">
              <div class="FirstRow">
                <div class="PrimaryAttribute" style="font-weight:bold; font-size:large;">

                    <ais-highlight attribute="restaurantname" :hit="item" class="lined mb-4" highlightedTagName="mark"  />
              ...
              <div class="SecondaryAttribute">
                <ais-snippet attribute="description" highlighted-tag-name="em" :hit="item"/>
              </div>
              <br>
              <div class="ThirdAttribute" style="font-family:verdana; color:purple">
  ...
  methods: {
    ...
    // },
     getStaticValues: (items) => {
      const staticValues = ["French", "Japanese", "Chinese", "International", "Western", "American", "Italian", "Peranakan", "European", "Bar", "Mediterranean", "Korean", "Asian"];
...
.InterfaceDemoHit .LabelAttribute, .InterfaceDemoHit .SecondaryAttribute, .InterfaceDemoHit .ThirdAttribute {
    font-size: 14px;
    line-height: 20px;
}

.InterfaceDemoHit .SecondaryAttribute, .InterfaceDemoHit .ThirdAttribute {
    margin-bottom: 12px;
}

.InterfaceDemoHit .PrimaryAttribute, .InterfaceDemoHit .SecondaryAttribute, .InterfaceDemoHit .ThirdAttribute {
...
@media (min-width: 768px) {
  .InterfaceDemoResultsZone.listDisplay .ais-InfiniteHits-list .InterfaceDemoHit .Image {
      height: 152px;
      margin-right: 24px;
      width: 152px;
  }
...
.InterfaceDemoResultsZone .ais-InfiniteHits .ais-InfiniteHits-list .ais-InfiniteHits-item {
    overflow: hidden;
}
...
#configure-grid-view-ui-builder, #configure-list-view-ui-builder {
    align-items: center;
