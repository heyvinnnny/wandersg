          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  It is a modern French cooking thats served at Lerouy. True to
                  the modern ethos that permeates the entire establishment, the
                  setting features an elegant, winding counter which curves
                  around an open kitchen. The restaurant offers a tasting menu
                  which evolves and changes from time to time, but which
                  constantly features exciting creations with the chef’s strong
                  individual stamp. The only thing predictable about Lerouy is
                  the consistently excellent cooking which never fails to
                  impress, so do head down sometime soon and give it a go!
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  Modern European, French, Fusion
                </p>
                <h4 class="h5 text-uppercase">Hours</h4>
                <p class="text-muted text-sm">
                  Wed-Sat: 12-2pm, 6-10pm <br />
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-food", "Lerouy");
