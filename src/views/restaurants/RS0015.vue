    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">Ambling Turtle
          ...
          <md-card>
            ...
            >
              <slide>
                ...
                <img src="@/assets/res-img/rs0015-1.jpg" alt="carousel1" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
                ...
                <img src="@/assets/res-img/rs0015-2.jpg" alt="carousel2" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
                ...
                <img src="@/assets/res-img/rs0015-3.jpg" alt="carousel2" />
              </slide>
            </carousel>
          </md-card>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8">
              ...
              <p class="text-muted">
              Step inside the classy and chic Ambling Turtle, a double-storey modern Peranakan Cafe that brings a fresh look to traditional Peranakan cuisine. Bringing brunch and tea time delights infused with authentic Peranakan flavours, you’re in for a nice treat at this chill cafe.

              </p>
              <p class="text-muted">For starters, we recommend their Pulled Beef Rendang Set. Choose from either a croissant or a sourdough to complete this hearty meal, and savour the taste of the smokey, tender beef grilled to perfection. If you’re looking for a more ‘lemak’ option, Ambling Turtle’s Nonya Chicken Curry Set makes for the perfect sharing dish among friends.
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">All-Day Breakfast, Local, Southeast Asian, Cafe, Dessert Only</p>
              <h4 class="h5 text-uppercase">Hours</h4>
              <p class="text-muted text-sm">Sun-Thu: 9am-6pm <br>
Fri-Sat: 9am-10pm<br></p>
              <h4 class="h5 text-uppercase">Good for: </h4>
              <p class="text-muted text-sm">Al Fresco, Business Meetings, Casual Dining, Kid Friendly, Pet Friendly</p>
              <h4 class="h5 text-uppercase">Location</h4>
              <p class="text-muted text-sm">East Coast</p>
              <h4 class="h5 text-uppercase">Address</h4>
              <p class="text-muted text-sm">66 East Coast Road<br>
#01-01<br>
The Flow<br>
Singapore (428778)<br>
                </p>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="Ambling Turtle" readonly></gmap-autocomplete>
