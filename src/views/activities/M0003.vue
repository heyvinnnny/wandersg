            ...
            <md-card>
              ...
              >
                ...
                <slide>
                  ...
                  <img
                    src="@/assets/act-img/m0003-2.jpg"
                    alt="carousel2"
                    style="height:auto;"
                  />
                </slide>
            ...
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  ...
                  and getting your instagram moments with your favourite super
                  heroes – Iron Man and Spiderman. Can’t decide between
                  Bollywood or Hollywood? We have both! Go on an audition to be
                  the next Bollywood superstar or get up close and personal with
                  all the famous people at our various zones – Music, A-List
                  Party, Sports, History and Leaders, Film and more. Next, take
                  a trip back down the memory lane and discover Singapore’s
                  transformation from a small village into a bustling
                  metropolis. Don't leave without hopping aboard The Spirit of
                  Singapore Boat Ride that takes you on a voyage through an
              ...
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  <md-button
                    class="md-danger"
                    style="width:100px;"
                    href="https://www.klook.com/en-SG/activity/1182-madame-tussauds-singapore/"
                    >KLOOK</md-button
                  >
                  <md-button
                    class="md-info"
                    style="width:100px; margin-left:20px;"
                    href="https://www.kkday.com/en-sg/product/5903-madame-tussauds-singapore-ticket-marvel-4d-ultimate-film-star"
                    >KKDAY</md-button
                  >
                </p>
          ...
          <div>
            <label>
              <gmap-autocomplete
                ...
                value="Madame Tussauds Singapore"
                style="width:300px;"
                readonly
              ></gmap-autocomplete>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-activity", "Madame Tussauds Singapore");
