          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Step inside the classy and chic Ambling Turtle, a
                  double-storey modern Peranakan Cafe that brings a fresh look
                  to traditional Peranakan cuisine. Bringing brunch and tea time
                  delights infused with authentic Peranakan flavours, you’re in
                  for a nice treat at this chill cafe.
                </p>
                <p class="text-muted">
                  For starters, we recommend their Pulled Beef Rendang Set.
                  Choose from either a croissant or a sourdough to complete this
                  hearty meal, and savour the taste of the smokey, tender beef
                  grilled to perfection. If you’re looking for a more ‘lemak’
                  option, Ambling Turtle’s Nonya Chicken Curry Set makes for the
                  perfect sharing dish among friends.
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  All-Day Breakfast, Local, Southeast Asian, Cafe, Dessert Only
                </p>
                ...
                <p class="text-muted text-sm">
                  Al Fresco, Business Meetings, Casual Dining, Kid Friendly, Pet
                  Friendly
                </p>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-food", "Ambling Turtle");
