          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Filled with so much goodness, our croissant packed with smoked
                  salmon, egg mayo and greens. Accompanied with a side of hearty
                  granola yoghurt and potato, mushroom cheese gratin. Complement
                  it with our specially curated beverages to provide you with
                  various options, it will give you the boost of energy to keep
                  you moving throughout the day!
                </p>
                <p class="text-muted">
                  Seafood Minestrone, Blacken Beef Salad to Texas Popeye Waffle
                  and Mascarpone Mousse with Breton Shortbread. There is
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-food", "9th ave.");
