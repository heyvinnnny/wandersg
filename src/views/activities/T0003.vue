    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">Adventure Cove Waterpark Singapore
          ...
          <md-card>
            ...
            >
              <slide>
                ...
                <img src="@/assets/act-img/t0003-1.jpg" alt="carousel1" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
                ...
                <img src="@/assets/act-img/t0003-2.jpg" alt="carousel2" style="height:auto;" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
                ...
                <img src="@/assets/act-img/t0003-3.jpg" alt="carousel2" />
              </slide>
            </carousel>
          </md-card>
        </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">Fri-Sun, 10:00-17:00, Closed on Mon-Thurs</p>
...
Singapore (098269)
              ...
              <p class="text-muted text-sm">
                <md-button class="md-danger" style="width:100px;" href="https://www.klook.com/en-SG/activity/120-adventure-cove-waterpark-singapore/">KLOOK</md-button>   
                <md-button class="md-info" style="width:100px; margin-left:20px;" href="https://www.kkday.com/en-sg/product/3070-adventure-cove-waterpark-ticket">KKDAY</md-button>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="Adventure Cove Waterpark Singapore" style="width:300px;" readonly></gmap-autocomplete>
