            ...
            <md-card>
              ...
              >
                <slide>
                  ...
                  <img src="@/assets/act-img/m0001-1.jpg" alt="carousel1" />
                </slide>
                <slide>
                  <div class="carousel-caption">
                    <h4></h4>
                  ...
                  <img
                    src="@/assets/act-img/m0001-2.jpg"
                    alt="carousel2"
                    style="height:auto;"
                  />
                </slide>
                <slide>
                  ...
                  <img src="@/assets/act-img/m0001-3.jpg" alt="carousel2" />
                </slide>
              </carousel>
            </md-card>
          </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Enter a world of wonder and discovery at Singapore’s
                  ArtScience Museum at Marina Bay Sands! Since its opening in
                  February 2011, the ArtScience Museum has become a must-visit
                  destination for both locals and tourists alike thanks to its
                  iconic lotus shape, its massive size of 6,000 square meters
                  filled with 21 different gallery spaces, and fascinating
                  exhibits! Catch unique exhibitions that are sure to quench any
                  thirst for knowledge. Discover the FUTURE WORLD: Where Art
                  Meets Science, a permanent exhibit popular among families with
                  children. Adult guests will love it as well! See the 16
                  different digital installations inside this kid-friendly
                  gallery and watch in awe as the interactive displays take you
                  on a full immersion at ArtScience Museum!
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">Marina Bay Sands</p>
                ...
                <p class="text-muted text-sm">
                  <md-button
                    class="md-danger"
                    style="width:100px;"
                    href="https://www.klook.com/en-SG/activity/2501-marina-bay-sands-artscience-museum-singapore/"
                    >KLOOK</md-button
                  >
                  <md-button
                    class="md-info"
                    style="width:100px; margin-left:20px;"
                    href="https://www.kkday.com/en-us/product/25521-artscience-museum-ticket-singapore"
                    >KKDAY</md-button
                  >
                </p>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-activity", "ArtScience Museum");
