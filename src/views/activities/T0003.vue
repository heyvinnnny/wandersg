            ...
            <md-card>
              ...
              >
                ...
                <slide>
                  ...
                  <img
                    src="@/assets/act-img/t0003-2.jpg"
                    alt="carousel2"
                    style="height:auto;"
                  />
                </slide>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Located at Sentosa Island in Singapore, Southeast Asia’s first
                  hydro-magnetic coaster isn’t its only claim to fame! Adventure
                  Cove Waterpark offers 14 thrilling rides and attractions where
                  you can enjoy to your heart’s content, from zooming down the
                  high-speed water slides of Dueling Racer to drifting lazily
                  down at Adventure River; snorkeling with amazing marine
                  animals at Rainbow Reef to wading with friendly rays in the
                  shallows at Ray Bay. Don’t miss to experience the shallow
                  wading pool and playful fountain at Seahorse Hideaway, the
                  open splash pool with twists and turns at Whirlpool Washout,
                  and have a blast at Southeast Asia’s first hydro magnetic
                  coaster at Riptide Rocket.
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  Fri-Sun, 10:00-17:00, Closed on Mon-Thurs
                </p>
                ...
                <p class="text-muted text-sm">
                  <md-button
                    class="md-danger"
                    style="width:100px;"
                    href="https://www.klook.com/en-SG/activity/120-adventure-cove-waterpark-singapore/"
                    >KLOOK</md-button
                  >
                  <md-button
                    class="md-info"
                    style="width:100px; margin-left:20px;"
                    href="https://www.kkday.com/en-sg/product/3070-adventure-cove-waterpark-ticket"
                    >KKDAY</md-button
                  >
                </p>
          ...
          <div>
            <label>
              <gmap-autocomplete
                ...
                value="Adventure Cove Waterpark Singapore"
                style="width:300px;"
                readonly
              ></gmap-autocomplete>
