        ...
        <div class="md-layout">
          <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
            <h1 class="text-uppercase lined mb-4" style="color:palevioletred">
              Sentosa Luge: Skyline Luge and Skyride
              <md-button
                v-if="loggedIn"
            ...
            <md-card>
              ...
              >
                ...
                <slide>
                  ...
                  <img
                    src="@/assets/act-img/p0001-2.jpg"
                    alt="carousel2"
                    style="height:auto;"
                  />
                </slide>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Part-go kart, part-toboggan, a trip to Skyline Luge will have
                  you racing down a purpose-built track with the wind in your
                  hair and the thrill of gravity's pull. Originating from New
                  Zealand over 27 years ago, Skyline Luge allows guests to hop
                  on a three-wheel type sled and have them control their descent
                  down the 1.2m track by pulling or pushing handlebars to brake
                  or accelerate. After you arrive down the track, you can head
                  back up onboard the scenic Sentosa Skyride - an open-cabin
                  trip with bird's eye views of Sentosa! Don’t miss out on the
                  chance to experience the only place in all of Asia that has
                  the Skyline Luge when you visit Singapore!
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  <md-button
                    class="md-danger"
                    style="width:100px;"
                    href="https://www.klook.com/en-SG/activity/132-skyline-luge-singapore/"
                    >KLOOK</md-button
                  >
                  <md-button
                    class="md-info"
                    style="width:100px; margin-left:20px;"
                    href="https://www.kkday.com/en-us/product/17924-skyline-luge-sentosa-singapore"
                    >KKDAY</md-button
                  >
                </p>
