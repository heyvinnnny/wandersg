    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">Bōruto
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">Mon-Sat: 11:30am-2:30pm, 6-10pm<br>
Closed Sunday<br></p>
              ...
              <p class="text-muted text-sm">80 South Bridge Road #01-01<br>
Singapore (058710)<br>
                </p>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="Bōruto" readonly></gmap-autocomplete>
