            ...
            <md-card>
              ...
              >
                <slide>
                  ...
                  <img src="@/assets/res-img/rs0003-1.jpg" alt="carousel1" />
                </slide>
                <slide>
                  <div class="carousel-caption">
                    <h4></h4>
                  </div>
                  <img src="@/assets/res-img/rs0003-2.jpg" alt="carousel2" />
                </slide>
                <slide>
                  <div class="carousel-caption">
                    <h4></h4>
                  </div>
                  <img src="@/assets/res-img/rs0003-3.jpg" alt="carousel2" />
                </slide>
              </carousel>
            </md-card>
          </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-muted">
                  Located on the lobby level, 10 SCOTTS exudes an aura of
                  elegance and relaxation with its contemporary yet classic
                  décor. 10 SCOTTS, one of the few restaurants in Singapore with
                  an address that is perfect for that business coffee meeting,
                  afternoon high tea or leisurely evening cocktail amidst
                  home-like space that exudes luxury.​
                </p>
                <p class="text-muted">
                  Enjoy a complimentary champagne package upgrade with every
                  "Themed Cocktails & Mocktails" package purchased when you sign
                  up as a World of Hyatt member at 10 SCOTTS, or if you are
                  already a World of Hyatt Elite member.
                </p>
              </div>
              <br />
              <div class="col-lg-4">
                ...
                <p class="text-muted text-sm">
                  Bar, Buffet, Japanese, Seafood, British
                </p>
                <h4 class="h5 text-uppercase">Hours</h4>
                <p class="text-muted text-sm">Mon-Sun: 12-5pm, 6-10pm</p>
...
export default {
  ...
  async created() {
    ...
    const item = doc(db, "wander-food", "10 SCOTTS");
