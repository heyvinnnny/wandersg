    ...
    <div class="main main-raised">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
          <h1 class="text-uppercase lined mb-4" style="color:palevioletred">9th ave.
          ...
          <md-card>
            ...
            >
              <slide>
                ...
                <img src="@/assets/res-img/rs0007-1.jpg" alt="carousel1" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
                ...
                <img src="@/assets/res-img/rs0007-2.jpg" alt="carousel2" />
              </slide>
              <slide>
                <div class="carousel-caption">
                  <h4>
                ...
                <img src="@/assets/res-img/rs0007-3.jpg" alt="carousel2" />
              </slide>
            </carousel>
          </md-card>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8">
              ...
              <p class="text-muted">
              Filled with so much goodness, our croissant packed with smoked salmon, egg mayo and greens. Accompanied with a side of hearty granola yoghurt and potato, mushroom cheese gratin. Complement it with our specially curated beverages to provide you with various options, it will give you the boost of energy to keep you moving throughout the day!

              </p>
              <p class="text-muted">Seafood Minestrone, Blacken Beef Salad to Texas Popeye Waffle and Mascarpone Mousse with Breton Shortbread. There is definitely something for everyone to enjoy!
            ...
            <div class="col-lg-4">
              ...
              <p class="text-muted text-sm">Fusion, Cafe, Western</p>
              <h4 class="h5 text-uppercase">Hours</h4>
              <p class="text-muted text-sm">Mon-Fri: 8am-4:30pm<br>
Closed Saturday, Sunday and PH</p>
              <h4 class="h5 text-uppercase">Good for: </h4>
              <p class="text-muted text-sm">Casual Dining</p>
              <h4 class="h5 text-uppercase">Location</h4>
              <p class="text-muted text-sm">Woodlands</p>
              <h4 class="h5 text-uppercase">Address</h4>
              <p class="text-muted text-sm">43 Woodlands Avenue 9<br>
SIT@RP<br>
Singapore (737729)
                </p>
      ...
      <div style="width:1000px; margin:auto;">
        <div>
          <label>
            <gmap-autocomplete @place_changed="initMarker" value="9th ave. Woodlands" readonly></gmap-autocomplete>
